...
const ConfirmDialog = ({
  ...
  const getConfirmButtonClass = () => {
    ...
    if (confirmButtonVariant === "primary")
      return "dialog-btn confirm-btn primary";
    if (confirmButtonVariant === "success")
      return "dialog-btn confirm-btn success";
    if (confirmButtonVariant === "danger")
      return "dialog-btn confirm-btn danger";
    return "dialog-btn confirm-btn primary";
  };

  const getCancelButtonClass = () => {
    if (cancelButtonVariant === "secondary")
      return "dialog-btn cancel-btn secondary";
    if (cancelButtonVariant === "outline")
      return "dialog-btn cancel-btn outline";
    return "dialog-btn cancel-btn secondary";
  };
  ...
  return (
    <div className="dialog-overlay" onClick={handleOverlayClick}>
      ...
      >
        ...
        {type !== "none" && (
          <div className={`dialog-icon ${type}`}>{renderIcon()}</div>
        )}
