...
const NoticeFilters = ({
  ...
  // Detect mobile view for responsive adjustments
  useEffect(() => {
    const checkMobile = () => {
        ...
        <div className="filter-group search-group">
          ...
          >
            ...
            <input
              type="text"
              placeholder={
                isMobile ? "Search..." : "Search by title or content..."
              }
            ...
            <div className="filter-group">
              <label className="filter-label checkbox-label">
                <input
                  ...
                  onChange={(e) =>
                    handleChange("hasAttachments", e.target.checked)
                  }
                />
